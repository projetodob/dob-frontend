  ...
  return (
    <div className="container flex flex-col mx-auto items-center">
      ...
      <form onSubmit={gerarNovoProduto} className="flex flex-col w-1/2 gap-4">
        ...
        <button disabled={carregandoCategoria} type='submit' className='rounded disabled:bg-slate-200 bg-orange-400 hover:bg-orange-800 text-white font-bold w-1/2 mx-auto block py-2'>
