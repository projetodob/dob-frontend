  ...
  return (
    <div className="max-w-sm bg-white mb-7 rounded-lg shadow dark:bg-white dark:border-black-700 transition duration-300 ease-in-out transform hover:scale-105 hover:text-black-600 flex flex-col">
      ...
      <div className="p-5 flex flex-col justify-between" style={{ height: 'calc(100% - 180px)' }}>
        ...
        <button onClick={() => retornar()} className='w-full inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>Comprar</button>
        </div>
      </div>
    </div>
