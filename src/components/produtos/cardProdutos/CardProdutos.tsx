...
function CardProduto({ prod }: CardProdutosProps) {
  return (
...
<div className="flex w-full bg-orange-400 py-2 px-4 items-center gap-4">
    ...
    <div className="p-5">
        ...
        <div>
          ...
          <button className='inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>Comprar</button>
